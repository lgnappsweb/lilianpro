    ...
    <div className="space-y-10 animate-in fade-in duration-500 w-full">
      <div className="flex flex-col items-center text-center gap-6 px-2">
        <div className="w-full">
          ...
          <p className="text-xs sm:text-xl text-muted-foreground mt-3 font-bold opacity-60 uppercase tracking-widest">Gerencie seu catálogo de contatos e histórico.</p>
        </div>
